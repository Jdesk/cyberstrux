...
- - In linux a symbolic link is created like so (this particular reference pertains to a popular webserver called nginx):

    sudo ln -s /etc/_nginx_/sites-available/testing /etc/_nginx_/sites-enabled/testing.

The reason I chose this example is because often 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTkxNjIwMDk3XX0=
-->