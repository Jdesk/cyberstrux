...
My typical setup for a Web Application uses a VPS, Remote Managed Database Service, Cacheing server, and a content delivery network.  This cuts down on 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTc0NjgwNTE4OV19
-->